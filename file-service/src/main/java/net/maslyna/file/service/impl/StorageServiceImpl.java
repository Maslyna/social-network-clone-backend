...
public class StorageServiceImpl implements StorageService {
    ...
    @Override public Blob upload(String filename, InputStream stream, String contentType) {
    ...
    @Override public boolean delete(String filename) {
        return storage.delete(BlobId.of(bucketName, filename));
    }

    @Override public String getLink(String filename) {
