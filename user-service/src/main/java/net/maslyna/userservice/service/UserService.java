...
import net.maslyna.userservice.exception.UserAlreadyExistsException;
import net.maslyna.userservice.exception.UserNotFoundException;
import net.maslyna.userservice.exception.UserRegistrationException;
import net.maslyna.userservice.exception.WrongDataException;
